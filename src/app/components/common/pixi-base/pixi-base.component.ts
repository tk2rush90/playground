...
import {AnimationService} from '@playground/services/animation/animation.service';
import * as PIXI from 'pixi.js';

@Component({
  selector: 'app-pixi-base',
  template: '',
})
export class PixiBaseComponent implements OnInit, AfterViewInit, OnDestroy {
  // application
